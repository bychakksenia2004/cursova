...
"[project]/app/api/attempts/me/route.ts [app-route] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
async function GET(req) {
    try {
        ...
        if (testQuery) {
            ...
            const matchingTestIds = await __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$models$2f$Test$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["default"].find({
                title: regex
            }).distinct("_id");
        ...
        if (authorQuery) {
            try {
                ...
                const User = (await __turbopack_context__.A("[project]/lib/models/User.ts [app-route] (ecmascript, async loader)")).default;
                ...
                const matchingTestIdsByAuthor = await __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$models$2f$Test$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["default"].find({
                    authorId: {
                        $in: matchingUserIds
                    }
                }).distinct("_id");
                ...
                if (q.testId && q.testId.$in) {
                    const intersection = q.testId.$in.filter((id)=>matchingTestIdsByAuthor.map(String).includes(String(id)));
        ...
        const total = await __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$models$2f$Attempt$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["default"].countDocuments(q);
        const attempts = await __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$models$2f$Attempt$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["default"].find(q).sort({
            createdAt: -1
        }).skip(skip).limit(limit).lean();
        const results = await Promise.all(attempts.map(async (a)=>{
            const test = await __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$models$2f$Test$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["default"].findById(a.testId).select("title ownResultView").lean();
...
//# sourceMappingURL=%5Broot-of-the-server%5D__19f52cca._.js.map