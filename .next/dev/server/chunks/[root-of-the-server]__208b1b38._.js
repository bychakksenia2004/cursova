...
async function GET(req) {
    try {
        ...
        try {
            ...
            console.warn("GET /api/me - getUserFromCookieServer failed:", e?.message ?? e);
        }
        // Fallback: try extract token from raw cookie header
        const tokenPair = headerCookie.split(";").map((s)=>s.trim()).find((s)=>s.startsWith("token="));
        ...
        const payload = (0, __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$auth$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["verifyToken"])(token, JWT_SECRET);
        ...
        await (0, __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$mongodb$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["connectToDB"])();
        const dbUser = await __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$models$2f$User$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["default"].findById(payload.sub).lean();
        if (!dbUser) {
            return __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$server$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["NextResponse"].json({
...
//# sourceMappingURL=%5Broot-of-the-server%5D__208b1b38._.js.map