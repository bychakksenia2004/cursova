...
"[project]/app/api/tests/[id]/route.ts [app-route] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
async function GET(req, ctx) {
    try {
        ...
        const id = params?.id;
        const test = await __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$models$2f$Test$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["default"].findById(id).lean();
...
async function PUT(req, ctx) {
    try {
        ...
        const transformed = (Array.isArray(questions) ? questions : []).map((q)=>{
            const common = {
                id: q.id,
                type: mapType(q.type),
                text: q.text
...
async function DELETE(req, ctx) {
    try {
        ...
        await __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$models$2f$Test$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["default"].findByIdAndDelete(id);
        return __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$server$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["NextResponse"].json({
            ok: true
        }, {
            status: 200
...
//# sourceMappingURL=%5Broot-of-the-server%5D__721b02ec._.js.map