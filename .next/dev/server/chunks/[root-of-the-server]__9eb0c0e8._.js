...
async function GET(req, ctx) {
    try {
        ...
        const test = await __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$models$2f$Test$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["default"].findById(String(testId)).lean();
        ...
        if (!test.storeResponses) return __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$server$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["NextResponse"].json({
            error: "Responses are not stored for this test"
        }, {
            status: 403
        });
        const url = new URL(req.url);
        const userQuery = (url.searchParams.get("user") || "").trim().toLowerCase();
        const attempts = await __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$models$2f$Attempt$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["default"].find({
...
//# sourceMappingURL=%5Broot-of-the-server%5D__9eb0c0e8._.js.map