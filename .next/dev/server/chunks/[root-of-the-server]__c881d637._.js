...
async function connectToDB() {
    ...
    if (!cached.promise) {
        ...
        cached.promise = __TURBOPACK__imported__module__$5b$externals$5d2f$mongoose__$5b$external$5d$__$28$mongoose$2c$__cjs$29$__["default"].connect(MONGODB_URL, {
            ...
            throw new Error("Не вдалося підключитися до MongoDB. Причини: неправильний MONGODB_URL, мережеві проблеми або IP не доданий до whitelist в MongoDB Atlas. " + "Перевірте значення MONGODB_URL у d:\\magistrature\\Dockerwork\\kursova\\.env.local, " + "додайте ваш IP або 0.0.0.0/0 в Atlas Network Access (тільки для dev), і перезапустіть dev-сервер. " + `Оригінальна помилка: ${err.message}`);
        });
    }
...
//# sourceMappingURL=%5Broot-of-the-server%5D__c881d637._.js.map